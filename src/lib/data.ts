...
export const tools: Tool[] = [
  // Перфораторы и дрели
  { name: "Шуруповерт Алтеко", price: 2000, brand: "Алтеко", category: "drills" },
  { name: "Перфоратор 3 Дж", price: 1500, brand: "Дензел", category: "drills" },
  { name: "Перфоратор 4 Дж", price: 2000, brand: "Дензел", category: "drills" },
  { name: "Перфоратор 5 Дж", price: 3000, brand: "Дензел", category: "drills" },
  { name: "Перфоратор 10 Дж", price: 3500, brand: "Дензел", category: "drills" },
  { name: "Отбойник 50 Дж", price: 4500, brand: "Краун", category: "drills" },
  { name: "Дрель", price: 1500, brand: "Алтеко", category: "drills" },
  { name: "Перфоратор АКБ", price: 3500, brand: "Алтеко", category: "drills" },

  // Болгарки и пилы
  { name: "Пчелка 125 мм", price: 1500, brand: "Алтеко", category: "grinders" },
  { name: "Пчелка 150 мм", price: 2000, brand: "Алтеко", category: "grinders" },
  { name: "Болгарка 115 мм", price: 1500, brand: "Алтеко", category: "grinders" },
  { name: "Болгарка 125 мм", price: 1500, brand: "Алтеко", category: "grinders" },
  { name: "Болгарка 230 мм", price: 2500, brand: "Алтеко", category: "grinders" },
  { name: "Болгарка АКБ", price: 3000, brand: "Алтеко", category: "grinders" },
  { name: "Торцовка 255 мм", price: 4500, brand: "Алтеко", category: "grinders" },
  { name: "Торцовка 255 мм выдвижная", price: 5000, brand: "Алтеко", category: "grinders" },
  { name: "Лобзик", price: 2000, brand: "Алтеко", category: "grinders" },
  { name: "Сабельная пила Bosh", price: 2500, brand: "Bosh", category: "grinders" },
  { name: "Пила бензиновая", price: 5000, category: "grinders" },
  { name: "Пила электрическая", price: 4500, category: "grinders" },
  { name: "Плиткорез 600 мм", price: 2500, category: "grinders" },
  { name: "Плиткорез 1200 мм", price: 4000, category: "grinders" },
  ...
  // Компрессоры
  { name: "Компрессор 25 л без масла", price: 3500, brand: "Дензел", category: "compressors" },
  { name: "Компрессор 50 л 1 поршень", price: 4000, brand: "Дензел", category: "compressors" },
  { name: "Компрессор 50 л 2 поршня", price: 4500, brand: "Дензел", category: "compressors" },
  { name: "Компрессор 80-100 л", price: 6500, brand: "Дензел", category: "compressors" },
  { name: "Краскопульт безвоздушный 395", price: 9000, brand: "Мастбро", category: "compressors" },
  { name: "Краскопульт для компрессора", price: 1500, category: "compressors" },
  { name: "Пневмо пистолет", price: 500, category: "compressors" },

  // Сварка и резка
  { name: "Сварочный аппарат Ресанта", price: 3000, brand: "Ресанта", category: "welding" },
  { name: "Сварочный аппарат Дензел", price: 3000, brand: "Дензел", category: "welding" },
  { name: "Штроборез Вихрь", price: 3500, brand: "Вихрь", category: "welding" },
  { name: "Штроборез Алтеко", price: 4000, brand: "Алтеко", category: "welding" },
  { name: "Реноватор АКБ МФИ", price: 3000, category: "welding" },

  // Тепловые пушки
  { name: "Пушка электрическая 2 кВт", price: 2000, brand: "Дензел", category: "heating" },
  { name: "Пушка электрическая 3 кВт", price: 2500, brand: "Дензел", category: "heating" },
  { name: "Пушка электрическая 5 кВт", price: 3000, brand: "Дензел", category: "heating" },
  { name: "Пушка электрическая 15 кВт", price: 5000, category: "heating" },
  { name: "Пушка газовая 30 кВт", price: 2500, brand: "Дензел", category: "heating" },
  { name: "Пушка дизельная 30 кВт", price: 5000, brand: "Дензел", category: "heating" },
  ...
  // Сад и участок
  { name: "Триммер", price: 5000, brand: "Дензел", category: "garden" },
  { name: "Газонокосилка", price: 5000, brand: "Матрикс", category: "garden" },
  { name: "Воздуходув", price: 1500, brand: "Дензел", category: "garden" },
  { name: "Мотобур", price: 5000, category: "garden" },

  // Измерительные
  { name: "Лазерный уровень", price: 2500, brand: "Дензел", category: "measuring" },
  { name: "Дальномер", price: 2000, category: "measuring" },

  // Прочее
  { name: "Вибратор глубинный 1.5 м", price: 2000, category: "other" },
  { name: "Миксер Фиолен", price: 2500, brand: "Дензел", category: "other" },
  { name: "Миксер Дензел", price: 2500, brand: "Дензел", category: "other" },
  { name: "Гайковерт АКБ", price: 3500, category: "other" },
  ...
  { name: "Фен промышленный", price: 1500, category: "other" },
  { name: "Утюг Дензел", price: 1500, brand: "Дензел", category: "other" },
  { name: "Стремянка 6 ступеней", price: 2000, category: "other" },
  { name: "Катушка", price: 1500, category: "other" },
  { name: "Катушка силовая", price: 2500, category: "other" },
];
